...
//				FinishedLED = led_flash_NO = (UINT8)(uart.rBuffer[5]);
...
//				led_time_refresh = 0;						// 让闪烁时间到
			...
			{
//				led_flash_mode = LED_FLASH_MODE_ALWAYS;
//				KeyPressLed = led_flash_NO = (UINT8)(uart.rBuffer[5]);
//				ClearFlg	= OFF;
//				SaveParaToBlock();
